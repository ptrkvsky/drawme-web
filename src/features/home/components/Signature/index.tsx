...
import { SvgSignature } from "./style";
...
const Signature = () => {
  ...
  const refLine4 = useRef<SVGPathElement>(null);
  const refLine5 = useRef<SVGPathElement>(null);
  const refLine6 = useRef<SVGPathElement>(null);
  const refLine7 = useRef<SVGPathElement>(null);
  const refLine8 = useRef<SVGPathElement>(null);
  const refLine9 = useRef<SVGPathElement>(null);
  const refLine10 = useRef<SVGPathElement>(null);
  const refLine11 = useRef<SVGPathElement>(null);
    ...
    >
      <g id="bg-sig" mask="url(#mask)">
        <path
          ...
          stroke="black"
          strokeWidth="1px"
          d="M6.9,37.08c0-2.91,1.1-8.36,6.38-16.11c5-7.31,11.49-12.87,17.27-12.87c8.85,0,2.8,18.97-2.91,32.94
	 ...
	 C8.33,41.53,6.9,39.39,6.9,37.08z"
        ...
        <path
          ...
          strokeWidth="1px"
          ref={refLine2}
          d="M39.24,28.56c0.11-0.22,0.66-0.6,0.94-2.31c0.17-1.37-0.33-1.59-0.33-1.87c0.11-0.27,0.72-0.83,1.1-0.17
	 c0.33,0.71,0.38,1.65,0.17,2.69c-0.33,1.04-0.83,2.42-1.71,2.25C39.13,29.16,39.08,28.78,39.24,28.56z"
        ...
        <path
          ...
          stroke="black"
          strokeWidth="1px"
          d="M51.29,41.42C53.65,25.04,65.53,1.5,70.04,1.5c5.06,0-0.71,14.35-5.22,21.83c-3.57,5.88-8.19,13.86-12.15,18.15
	 ...
	 c3.57-4.29,7.81-11.6,10.72-16.33c7.48-12.04,8.14-20.35,6.27-20.35C67.23,2.82,56.07,23.83,52.99,39.5z"
        ...
        <path
          className="path"
          ref={refLine4}
          d="M99.96,20.47l1.32-3.57c2.2-5.94,2.42-6.65,2.92-6.65c0.49,0,1.32,1.1,1.21,1.65c-0.05,0.27-1.48,2.97-3.63,6.87
	 ...
	 c-0.33-0.05-0.66-0.11-0.99-0.11c-4.12,0-7.09,5.11-7.09,8.69c0,0.93,0.05,2.09,0.55,2.09C84.07,45.99,89.02,38.67,91,35.32z"
        ...
        <path
          className="path"
          ref={refLine5}
          d="M100.4,43.07c0-0.22-0.06-0.6,0.05-2.03c0.17-2.03,0.94-6.32,1.15-6.82c0.28-0.5,1.65-0.6,1.71-0.17
	 ...
	 C100.79,43.68,100.4,43.24,100.4,43.07z"
        ...
        <path
          className="path"
          ref={refLine6}
          d="M134.83,35.1c-0.66,0.17-3.3,1.65-9.62,3.79c-5,1.7-6.27,1.98-7.15,1.98c-1.43,0-1.87-0.99-1.87-1.87
	 ...
	 C118.99,30.43,118.77,29.49,118.88,29.11z"
        ...
        <path
          className="path"
          ref={refLine7}
          d="M138.24,34.16c-0.17-0.22-0.22-0.44-0.22-0.71c0-0.38,0.6-1.26,1.15-1.26c0.33,0,0.5,0.22,0.44,0.6
	 ...
	 C135.27,37.52,137.19,35.81,138.24,34.16z"
        ...
        <path
          className="path"
          ref={refLine8}
          d="M151.05,42.03c-2.86,0.22-4.12-2.2-2.97-4.73c1.1-2.53,3.3-3.52,4.45-3.3c1.04,0.17,1.38,1.04,0.93,2.31
	 ...
	 c-0.6-0.17-2.36,0.55-3.3,2.86C148.8,38.29,148.69,38.78,148.69,39.22z"
        ...
        <path
          className="path"
          ref={refLine9}
          d="M173.71,38.45c-0.33,1.81,0,2.36,0.05,2.36c0.99,0,3.96-3.24,7.42-9.02c2.53-4.23,5.33-12.1,7.86-16.83
	 ...
	 C174.98,27.62,174.76,26.74,174.76,26.41z"
        ...
        <path
          className="path"
          ref={refLine10}
          d="M183.78,49.51c0.11-3.35,0.94-14.9,2.58-23.76c0.38-2.04,0.77-3.85,1.16-5.5c-10.72,0-11.71,0.06-11.93-0.77
	 ...
	 c0.28,2.09,0.71,2.31-0.05,2.42C184.22,55.78,183.72,53.58,183.78,49.51z"
        ...
        <path
          className="path"
          ref={refLine11}
          d="M225.08,35.76c0.22-0.6,1.65-0.44,1.65,1.65c0,1.48-1.15,3.63-3.13,3.57c-1.1,0-1.76-0.94-1.7-2.31
	 ...
	 C210.78,55.06,209.41,52.81,205.72,50.94z"
        ...
        <path
          className="path"
          d="M229.54,43.07c0-0.22-0.05-0.6,0.05-2.03c0.17-2.03,0.93-6.32,1.16-6.82c0.27-0.5,1.65-0.6,1.7-0.17
	 ...
	 C229.92,43.68,229.54,43.24,229.54,43.07z"
        ...
        <path
          className="path"
          d="M265.67,39.06c-1.92,2.09-3.85,4.01-5.11,4.01c-0.77,0-1.43-0.71-1.1-1.98c0.38-1.38,0.88-3.13,1.26-4.29
	 ...
	 c-6.65,6.71-9.29,12.98-9.29,16.11c0,1.59,0.66,2.58,1.92,2.58c2.03,0,5.44-2.25,8.25-7.2C268.8,51.49,270.56,43.9,270.67,40.16z"
        ...
        <path
          className="path"
          d="M282.01,36.69c-0.28-0.27-0.55-0.55-0.71-0.94c-0.99-2.09,0.83-4.56,3.24-4.56c2.42,0,3.9,2.25,3.9,5.72v0.17
	 ...
	 c0.33,0,0.49,0.17,0.49,0.38C284.92,34.99,284.31,35.54,283.6,36.42z"
        />
        <path
          d="M305.27,36.69c-0.38,0.44-0.99,1.15-2.03,2.25c-1.87,1.98-5,4.4-5.99,4.4c-0.77,0-1.21-0.44-1.1-1.87
	 ...
	 C303.62,40.54,304.5,38.18,305.27,36.69z"
        />
        <path
          d="M335.68,41.04c0.77-0.88,1.71-1.32,2.31-1.32c0.55,0-0.22,1.27-0.55,1.65c-0.27,0.33-1.15,1.1-1.37,1.1
